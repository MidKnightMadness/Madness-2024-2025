package org.firstinspires.ftc.teamcode.PathingRR.Util;
...
import org.firstinspires.ftc.teamcode.PathingRR.Drive.StandardTrackingWheelLocalizer;
    ...
    private static final OpModeManagerNotifier.Notifications notifHandler = new OpModeManagerNotifier.Notifications() {
        ...
        public void onOpModePostStop(OpMode opMode) {
            ...
            if (!(opMode instanceof OpModeManagerImpl.DefaultOpMode)) {
                ...
                try {
                    jsonWriter.writeValue(file, log);//serializing log to file
                } catch (IOException e) {
